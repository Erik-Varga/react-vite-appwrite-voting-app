...
export default function Question({ data }) {
    ...
    return(
        <>
            <h2 className="text-2xl md:text-3xl text-center font-bold">{data.text}</h2>
            
            <form 
                onSubmit={handleSubmit}
                className="flex flex-col gap-1 votes-container"
            >
                <Vote
                    text={data.answer_1}
                ...
                <button
                    ...
                    className="cursor-pointer ml-auto mt-6 rounded shadow bg-green-400 text-white font-medium text-lg py-2 px-10 transition hover:bg-white hover:text-green-600 hover:outline-green-800 disabled:cursor-not-allowed disabled:bg-gray-400 disabled:text-gray-100"
                >
                    Submit your vote
                </button>
            </form>
